...
public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t=0; t < N -1; t++) {
      ...
      // Adding penalty for speed and steer
    ...
    for (int t = 1; t < N; t++) {
      ...
      AD<double> eps1 = vars[epsi_start + t];
      ...
      AD<double> eps0 = vars[epsi_start + t -1];
      ...
      fg[1+ epsi_start + t] = eps1 - ((psi0 - psides0) - (v0/Lf) * delta * dt);
    }
  }
};
